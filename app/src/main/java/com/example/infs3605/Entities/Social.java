...
public class Social {
    ...
    public static ArrayList<Social> getSocialList() {
        ...
        socialList.add((new Social(1, R.drawable.wanyara_icon,"wanyara.aus", R.drawable.social1,
                "Our art sessions include some storytelling, connection and protocol.\n" +
                        ...
                        "\n" +
                        "www.wanyara.com.au")));
        socialList.add((new Social(2, R.drawable.wanyara_icon,"wanyara.aus", R.drawable.social2,
        ...
        socialList.add((new Social(3, R.drawable.wanyara_icon,"wanyara.aus", R.drawable.social3,
        ...
        socialList.add((new Social(4, R.drawable.wanyara_icon,"wanyara.aus", R.drawable.social4,
                "Wanyara are the home of TAG (Traditional Aboriginal Games) however don’t forget we offer a number of different sessions.")));
        socialList.add((new Social(5, R.drawable.wanyara_icon,"wanyara.aus", R.drawable.social5,
        ...
        socialList.add((new Social(6, R.drawable.jsly_icon,"j.sly_indigenous_designs", R.drawable.social6,
                "Happy Saturday mob \uD83D\uDE4C\uD83C\uDFFD\n" +
                        "\n" +
                        "Action shot from my most recent mural! ✍\uD83C\uDFFD\uD83C\uDFA8\uD83C\uDFA8\n" +
                        "Can’t wait to share the final piece with everyone very soon \uD83D\uDD25\uD83D\uDD25")));
        socialList.add((new Social(7, R.drawable.jsly_icon,"j.sly_indigenous_designs", R.drawable.social7,
        ...
        socialList.add((new Social(8,R.drawable.dylanbarnes_icon,"dylan.barnes.art", R.drawable.social8,
                "\"Dungal Wambadar\"\n" +
                        ...
                        "\n" +
                        "(August 2020)")));
        socialList.add((new Social(9,R.drawable.dylanbarnes_icon,"dylan.barnes.art", R.drawable.social9,

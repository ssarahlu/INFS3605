...
public class Learnings {
    ...
    public static ArrayList<Learnings> getLearnings() {
        ...
        learnings.add(new Learnings(0, "<b>Beliefs and culture through art</b>\n" +
        ...
        learnings.add(new Learnings(1, "<b>Ownership of art</b>\n" +
        ...
        learnings.add(new Learnings(2, "<b>Modernising Indigenous art</b>\n" +
        ...
        learnings.add(new Learnings(20, "<b>The Jin of Wirajiduri People</b>\n" +

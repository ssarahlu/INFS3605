...
public class Modules {
    ...
    public static ArrayList<Modules> getModules() {
        ...
        modules.add(new Modules(7, "Goo-Goor-Gaga the Kookaburra", "Music & Dance, Ceremonies","This module begins by exploring the tale of Goo-Goor-Gaga the Kookaburra. Next, we will learn about the use of music, dance, and ceremonies in Aboriginal culture.",  "https://www.kullillaart.com.au/assets/images/Kookaburra.jpg", 0));
        modules.add(new Modules(6, "Wayambeh the Turtle", "Walpiri language","In this module you will learn about the importance of First Nations language, specifically the Walpiri language, through the tale of Wayambeh the very stubborn turtle.",  "https://www.kullillaart.com.au/assets/images/turtle.jpg", 3));

        modules.add(new Modules(4, "Dadirri - Deep Listening", "Aboriginal meditation","In this lesson you will learn about the Aboriginal practice of deep listening, an almost spiritual skill, based on respect. Sometimes called 'dadirri', deep listening is inner, quiet, still awareness, and waiting.",  "https://images.squarespace-cdn.com/content/v1/58a25919db29d63c7fae5195/1514803679139-IQ7R0UC4JW3CQPES8XFY/Alf%27s+spot+copy.jpg?format=2500w", 1));
